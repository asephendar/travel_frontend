...
// Fungsi untuk menampilkan jadwal di halaman
export function displaySchedulesIndex(schedules) {
  const carGallery = document.getElementById('carOurFleet');
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <ul class="list-group list-group-flush">
                          ...
                          <li class="list-group-item">Departure Schedule : ${schedule.date_trip}</li>
