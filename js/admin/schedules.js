    ...
    const row = `
      <tr>
        ...
        <td class="text-center">
          <button type="button" class="btn btn-warning btn-sm edit-schedules-btn" data-bs-toggle="modal" data-bs-target="#editSchedulesModal" data-schedules-id="${schedule.id_schedule}">
